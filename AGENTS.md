...
| `aws-cloud-architect` | Principal cloud architect with 20+ years across regulated industries (fintech, healthcare, automotiv | `.ai/skills/aws-cloud-architect/SKILL.md` |
| `azure-cloud-architect` | Principal cloud architect with 20+ years across regulated industries (fintech, healthcare, automotiv | `.ai/skills/azure-cloud-architect/SKILL.md` |
...
| `content-marketing-expert` | Packages marketing content for Reels, Shorts, blogs, and social derivatives with plain-language copy | `.ai/skills/content-marketing-expert/SKILL.md` |
...
| `contribution-summary` | Generate a plain-markdown weekly contribution summary from local git history, .ai/memory/ episodic n | `.ai/skills/contribution-summary/SKILL.md` |
...
| `database-architect` | Principal database architect with 20+ years across regulated industries (fintech, healthcare, automo | `.ai/skills/database-architect/SKILL.md` |
...
| `memory-curator` | Write, dedupe, promote, and prune notes in the .ai/memory/ agentic memory store. Applies the frontma | `.ai/skills/memory-curator/SKILL.md` |
...
| `roadmap-review` | Assess milestone confidence and give feedback on .ai/memory/prospective/roadmap.md using determinist | `.ai/skills/roadmap-review/SKILL.md` |
...
| `memory-steward` | Curates the agentic memory store end to end: writes and dedupes notes, runs staleness sweeps, and op | `.ai/subagents/memory-steward.md` |
